...
// --- MOCK SPORTS BRANDS ---
const CLIENTS = [
  { name: "Global Athletics", icon: Trophy },
  { name: "Peak Performance", icon: Activity },
  { name: "Swift Strike", icon: Zap },
  { name: "Elite Medalist", icon: Medal },
  { name: "Court Kings", icon: Dribbble },
  { name: "Victory Lane", icon: Flag },
];
  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      */}
      ...
      {/* Background Image with Gradient Mask - Sports Stadium */}
      <div 
        className="absolute inset-0 z-0 bg-[url(https://images.unsplash.com/photo-1541252260730-0412e8e2108e?q=80&w=2070&auto=format&fit=crop)] bg-cover bg-center opacity-40"
        style={{
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              Experience the thrill of the game through immersive storytelling, 
              expert analysis, and behind-the-scenes access to the world's greatest athletes.
            </p>
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-zinc-400">Athletes Profiled</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Fan Engagement</span>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <StatItem value="10k+" label="Articles" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="Live" label="Updates" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Trusted by Global Athletes</h3>
